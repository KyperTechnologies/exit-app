  ...
  return (
    <Card
      sx={{
        ...
        borderRadius: "4px",
        boxShadow:
          "rgba(0, 0, 0, 0.2) 0px 2px 0px 3px, rgba(0, 0, 0, 0.14) 0px 1px 1px 2px, rgba(0, 0, 0, 0.12) 0px 1px 3px 2px",
        color: "black",
        margin: "30px",
        minWidth: "250px",
      }}
    >
      ...
      <div>
        <Dialog open={open} onClose={handleClose}>
          <DialogTitle
            sx={{ fontWeight: "bold", color: "black", backgroundColor: "#fff" }}
          >
            VERESİYE ÖDEME ALMA
          </DialogTitle>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText
                ...
                fontWeight="bold"
              >
                Kalan tutar sıfırdan küçük olmamalıdır , lütfen tekrar kontrol
                ediniz.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
