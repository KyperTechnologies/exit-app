...
export default function ImgMediaCard(props) {
  ...
  const onButtonClickToCheckout = (state) => {
    navigate("/checkout", {
      state: { tableId: table.id, tableName: table.name },
    });
  };
    ...
    <React.Fragment>
      <Card
        sx={{
          ...
          borderRadius: "4px",
          boxShadow:
            "rgba(0, 0, 0, 0.2) 0px 2px 1px -1px, rgba(0, 0, 0, 0.14) 0px 1px 1px 2px, rgba(0, 0, 0, 0.12) 0px 1px 3px 2px",
          color: "#00",
          minWidth: "240px",
        }}
      >
        <CardActionArea onClick={handleOpen}>
          <CardContent>
            <Typography variant="h4" key={table.id}>
              {table.name}
            </Typography>
          </CardContent>
        </CardActionArea>
        <CardActions style={{ justifyContent: "space-around" }}>
          ...
          <Button
            style={{ color: "#004225", borderColor: "#004225" }}
            variant="outlined"
            onClick={() => {
              onButtonClickToOrder();
            }}
          >
            SİPARİŞ
          </Button>
          <Button
            ...
            variant="contained"
            onClick={() => onButtonClickToCheckout("/checkout")}
            endIcon={<SendIcon />}
          >
            HESAP
          </Button>
